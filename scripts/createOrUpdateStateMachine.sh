...
echo "$FANDUEL_LAMBDA_ARN"
echo "$PROJECTIONS_LAMBDA_ARN"
echo "$GOALIE_SCRAPER_LAMBDA_ARN"
echo "$MERGE_DATA_LAMBDA_ARN"
echo "$OPTIMAL_LINEUP_LAMBDA_ARN"
echo "$SEND_OPTIMAL_LINEUP_TEXTS_LAMBDA_ARN"
echo "$DFS_PIPELINE_STEP_FUNCTION_ARN"
echo "$DFS_PIPELINE_STEP_FUNCTION_ROLE_ARN"
